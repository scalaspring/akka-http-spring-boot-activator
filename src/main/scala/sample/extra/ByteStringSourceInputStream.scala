 ...
 *
 * Note: This class is for demonstration purposes only, illustrating the use of the AsyncStage class as a means of
 * connecting push-based reactive streams code with traditional pull-based code. This is *not* a complete implementation.
 */
